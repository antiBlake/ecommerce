  ...
  return (
    <div className='mt-12 flex flex-col items-center mx-4'>
        ...
        <div className='mt-12 flex flex-row items-center justify-between w-full gap-x-2'>
            <div className='w-4/12 h-40 border-2 rounded-lg flex flex-col justify-center items-center gap-y-2 shadow-lg hover:border-black cursor-pointer'>
                <h1 className='text-base'>MONTHLY</h1>
                <p className='text-2xl'>₦1000</p>
            </div>
            <div className='w-4/12 h-40 border-2 rounded-lg flex flex-col justify-center items-center gap-x-2 shadow-lg hover:border-black relative cursor-pointer'>
            ...
            <div className='w-4/12 h-48 border-2 rounded-lg flex flex-col justify-center items-center gap-x-2 shadow-lg hover:border-black relative cursor-pointer'>
        ...
        <button className='w-full bg-black text-white text-lg md:text-xl mt-12 rounded-lg py-3'>Subscribe to yearly plan </button>
